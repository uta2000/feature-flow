...
**Step IDs:** use the lowercase, kebab-case step names corresponding to the Step List for the scope. Canonical IDs across all scopes:

- Quick fix path: `understand-problem`, `study-patterns`, `implement`, `self-review`, `verify-acceptance-criteria`, `sync`, `pr`, `wait-ci`, `post-comment`
